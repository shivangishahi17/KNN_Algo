...
# Spliting the datasetv into the traning set and test set
...
#Filtering Classifier to the traning set
...
# Making the confusion Matrix-A confusion matrix is a table that is often used to describe the performance of
